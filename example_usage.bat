...
%wiggle% fontgen %sspr% sspr.wfi sspr.png 128   96     4     8 4  8       1
%wiggle% fontgen %sspl% sspl.wfi sspl.png 128   96     4     8 4  8       1
%wiggle% fontgen %sspb% sspb.wfi sspb.png 128   96     4     8 4  8       1
